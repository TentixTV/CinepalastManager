...
def api_import():
    try:
        ...
        movie_data = {
            ...
            "Genre": details.get("genre_richtung") or details.get("genre"),
            "Filmreihe": details.get("filmreihe"),
            "FSK": details.get("fsk"),
            "Produktionsfirma": details.get("produktionsfirma_studio") or details.get("produktionsfirma"),
            "Produktionsland": details.get("produktionsland"),
            "Beschreibung": details.get("handlung_beschreibung") or details.get("beschreibung"),
            "Schauspieler": details.get("schauspieler_cast") or details.get("schauspieler"),
